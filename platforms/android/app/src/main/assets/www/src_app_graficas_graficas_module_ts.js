...
/* harmony import */ var _graficas_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./graficas.page */ 81127);
...
/* harmony import */ var _graficas_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./graficas-routing.module */ 31430);
/* harmony import */ var _graficas_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./graficas.page */ 81127);
/* harmony import */ var ng2_charts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ng2-charts */ 54527);
...
/* harmony import */ var _raw_loader_graficas_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./graficas.page.html */ 48346);
/* harmony import */ var _graficas_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./graficas.page.scss */ 45091);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ 80476);
/* harmony import */ var _services_pedidos_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/pedidos.service */ 14362);
...
let GraficasPage = class GraficasPage {
  ...
  public chartHovered({ event, active }: { event?: ChartEvent, active?: {}[] }): void {
    ...
    calcularCantidades(event) {
        ...
        let fecha1 = moment__WEBPACK_IMPORTED_MODULE_3__(formatoFecha1);
        ...
        let fecha2 = moment__WEBPACK_IMPORTED_MODULE_3__(formatoFecha2);
        ...
        let fecha3 = moment__WEBPACK_IMPORTED_MODULE_3__(formatoFecha3);
        ...
        let fecha4 = moment__WEBPACK_IMPORTED_MODULE_3__(formatoFecha4);
        ...
        let fecha5 = moment__WEBPACK_IMPORTED_MODULE_3__(formatoFecha5);
        ...
        let fecha6 = moment__WEBPACK_IMPORTED_MODULE_3__(formatoFecha6);
        ...
        let fecha7 = moment__WEBPACK_IMPORTED_MODULE_3__(formatoFecha7);
        ...
        let fecha8 = moment__WEBPACK_IMPORTED_MODULE_3__(formatoFecha8);
        ...
        let fecha9 = moment__WEBPACK_IMPORTED_MODULE_3__(formatoFecha9);
        ...
        let fecha10 = moment__WEBPACK_IMPORTED_MODULE_3__(formatoFecha10);
        ...
        let fecha11 = moment__WEBPACK_IMPORTED_MODULE_3__(formatoFecha11);
        ...
        //console.log(finalMes6.toLocaleDateString());
        let fecha12 = moment__WEBPACK_IMPORTED_MODULE_3__(formatoFecha12);
        ...
        for (var i = 0; i < ((_a = this.datosPedidos) === null || _a === void 0 ? void 0 : _a.length); i++) {
            if (this.idArticulo == ((_d = (_c = (_b = this.datosPedidos[i]) === null || _b === void 0 ? void 0 : _b.order_lines[0]) === null || _c === void 0 ? void 0 : _c.articles_line[0]) === null || _d === void 0 ? void 0 : _d.article_id)) {
                this.cantidadesArticulo += this.datosPedidos[i].order_lines[0].articles_line[0].num_articles;
                var fechaPedido = new Date((_f = (_e = this.datosPedidos[i]) === null || _e === void 0 ? void 0 : _e.order_lines[0]) === null || _f === void 0 ? void 0 : _f.issue_date);
                console.log(fechaPedido);
                let fecha = moment__WEBPACK_IMPORTED_MODULE_3__(fechaPedido);
                if (moment__WEBPACK_IMPORTED_MODULE_3__(fecha) >= moment__WEBPACK_IMPORTED_MODULE_3__(fecha1) && (moment__WEBPACK_IMPORTED_MODULE_3__(fecha) <= moment__WEBPACK_IMPORTED_MODULE_3__(fecha2))) {
                    console.log('mesSeis');
                    console.log(this.mesSeis);
                    this.mesSeis += this.datosPedidos[i].order_lines[0].articles_line[0].num_articles;
                }
                if (moment__WEBPACK_IMPORTED_MODULE_3__(fecha) >= moment__WEBPACK_IMPORTED_MODULE_3__(fecha3) && (moment__WEBPACK_IMPORTED_MODULE_3__(fecha) <= moment__WEBPACK_IMPORTED_MODULE_3__(fecha4))) {
                ...
                if (moment__WEBPACK_IMPORTED_MODULE_3__(fecha) >= moment__WEBPACK_IMPORTED_MODULE_3__(fecha5) && (moment__WEBPACK_IMPORTED_MODULE_3__(fecha) <= moment__WEBPACK_IMPORTED_MODULE_3__(fecha6))) {
                ...
                if (moment__WEBPACK_IMPORTED_MODULE_3__(fecha) >= moment__WEBPACK_IMPORTED_MODULE_3__(fecha7) && (moment__WEBPACK_IMPORTED_MODULE_3__(fecha) <= moment__WEBPACK_IMPORTED_MODULE_3__(fecha8))) {
                    console.log('mesTres');
                    console.log(this.mesTres);
                    this.mesTres += this.datosPedidos[i].order_lines[0].articles_line[0].num_articles;
                }
                if (moment__WEBPACK_IMPORTED_MODULE_3__(fecha) >= moment__WEBPACK_IMPORTED_MODULE_3__(fecha9) && (moment__WEBPACK_IMPORTED_MODULE_3__(fecha) <= moment__WEBPACK_IMPORTED_MODULE_3__(fecha10))) {
                    console.log('mesDos');
                    console.log(this.mesDos);
                    this.mesDos += this.datosPedidos[i].order_lines[0].articles_line[0].num_articles;
                }
                console.log(moment__WEBPACK_IMPORTED_MODULE_3__(fecha));
                if (moment__WEBPACK_IMPORTED_MODULE_3__(fecha) >= moment__WEBPACK_IMPORTED_MODULE_3__(fecha11) && (moment__WEBPACK_IMPORTED_MODULE_3__(fecha) <= moment__WEBPACK_IMPORTED_MODULE_3__(fecha12))) {
                    console.log('mesUno');
...
GraficasPage = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
