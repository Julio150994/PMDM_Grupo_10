...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'graficas',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_graficas_graficas_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./graficas/graficas.module */ 8506)).then(m => m.GraficasPageModule)
            }
        ]
    },
    {
